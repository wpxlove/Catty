...
let kLocalizedAnimateBrick = NSLocalizedString("Animate Brick", comment: "")
...
let kLocalizedFaceDetectionFrontCamera = NSLocalizedString("Use front camera", comment: "")
...
let kLocalizedNoOrTooShortInputDescription = NSLocalizedString("No input or the input is too short. Please enter at least %lu character(s).", comment: "")
...
let kLocalizedPaintPickItem = NSLocalizedString("Please pick an item", comment: "paint")
