...
#define kLocalizedQRCodeReader NSLocalizedString(@"QR Code Reader", @"Title of the QR Code reader used to download Scratch converted Catrobat programs from the Internet")
